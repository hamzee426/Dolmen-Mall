      ...
      show && (
        ...
        <div className={css.overlay}>
          <div className={css.contenta}>
            ...
            {status==="Create" ?
            <>
            <h3 className={css.header}>Create Department</h3>
            <p style={{color:"#000",fontWeight:"400",fontSize:"17px", marginBottom:"4px", marginLeft:"80px"}}>{titlee} Name</p>
            <MDBInput className='inp' wrapperClass='mb-4' label='' id='DOB' type='DOB' size="md" placeholder='Department Name'> </MDBInput>
            
            </>
            :status==="Edit" ?
            <>
            <h3 className={css.header}>Edit Department</h3>
            <p style={{color:"#000",fontWeight:"400",fontSize:"17px", marginBottom:"4px", marginLeft:"80px"}}>{titlee} Name</p>
            <MDBInput className='inp' wrapperClass='mb-4' label='' id='DOB' type='DOB' size="md" placeholder='I am --- Department'value='I am --- Teanut'> </MDBInput>
